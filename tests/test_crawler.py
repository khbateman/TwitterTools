...
def test_user_crawler_02(get_driver):
    current_dir = os.path.dirname(__file__)
    with open(os.path.join(current_dir, "Testing_Resources/user_02_verified_follows-me_not-following-them_not-protected.html")) as f:
        html = f.readlines()[0]
...
def test_user_crawler_03(get_driver):
    current_dir = os.path.dirname(__file__)
    with open(os.path.join(current_dir, "Testing_Resources/user_03_verified_doesnt-follow-me_following-them_not-protected.html")) as f:
        html = f.readlines()[0]
...
def test_user_crawler_04(get_driver):
    current_dir = os.path.dirname(__file__)
    with open(os.path.join(current_dir, "Testing_Resources/user_04_verified_doesnt-follow-me_not-following-them_protected.html")) as f:
        html = f.readlines()[0]
...
def test_user_crawler_05(get_driver):
    current_dir = os.path.dirname(__file__)
    with open(os.path.join(current_dir, "Testing_Resources/user_05_verified-doesnt-follow-me-not-following-them_not-protected.html")) as f:
        html = f.readlines()[0]
...
def test_user_crawler_06(get_driver):
    current_dir = os.path.dirname(__file__)
    with open(os.path.join(current_dir, "Testing_Resources/user_06_not-verified_follows-me_following-them_protected.html")) as f:
        html = f.readlines()[0]
...
def test_user_crawler_07(get_driver):
    current_dir = os.path.dirname(__file__)
    with open(os.path.join(current_dir, "Testing_Resources/user_07_not-verified_follows-me_following-them_not-protected.html")) as f:
        html = f.readlines()[0]
...
def test_user_crawler_08(get_driver):
    current_dir = os.path.dirname(__file__)
    with open(os.path.join(current_dir, "Testing_Resources/user_08_not-verified_follows-me_not-following-them_protected.html")) as f:
        html = f.readlines()[0]
...
def test_user_crawler_09(get_driver):
    current_dir = os.path.dirname(__file__)
    with open(os.path.join(current_dir, "Testing_Resources/user_09_not-verified_follows-me_not-following-them_not-protected.html")) as f:
        html = f.readlines()[0]
...
def test_user_crawler_10(get_driver):
    current_dir = os.path.dirname(__file__)
    with open(os.path.join(current_dir, "Testing_Resources/user_10_not-verified_doesnt-follow-me_following-them_protected.html")) as f:
        html = f.readlines()[0]
...
def test_user_crawler_11(get_driver):
    current_dir = os.path.dirname(__file__)
    with open(os.path.join(current_dir, "Testing_Resources/user_11_not-verified_doesnt-follow-me_following-them_not-protected.html")) as f:
        html = f.readlines()[0]
...
def test_user_crawler_12(get_driver):
    current_dir = os.path.dirname(__file__)
    with open(os.path.join(current_dir, "Testing_Resources/user_12_not-verified_doesnt-follow-me_not-following-them_protected.html")) as f:
        html = f.readlines()[0]
...
def test_user_crawler_13(get_driver):
    current_dir = os.path.dirname(__file__)
    with open(os.path.join(current_dir, "Testing_Resources/user_13_not-verified_doesnt-follow-me_not-following-them_not-protected.html")) as f:
        html = f.readlines()[0]
...
def test_user_crawler_15(get_driver):
    current_dir = os.path.dirname(__file__)
    with open(os.path.join(current_dir, "Testing_Resources/user_15_user_with_emoji_in_name.html")) as f:
        html = f.readlines()[0]
